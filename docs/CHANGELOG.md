...
### Fixed
- register the plugin-shell smoke test so review test can find it
...
### Changed
- refactor(team-members): write the extra_chill_team role directly
- migrate to wp-native-client (partial — see gaps)
...
### Changed
- Remove admin tools surface styling covered by shared panels

## [2.1.7] - 2026-03-25

### Changed
- Adopt shared shell layer in admin tools and remove fake components alias

## [2.1.6] - 2026-03-19

### Changed
- remove artist access ability registrations (moved to extrachill-users)

## [2.1.5] - 2026-03-05

### Changed
- Make QR ability primitive support optional size input with bounded defaults (100-2000).

## [2.1.4] - 2026-03-05

### Refactored
- Refactor src/api/client.js into a single module object with named exports to reduce top-level item sprawl.

## [2.1.3] - 2026-03-05

### Refactored
- Refactor Abilities API integration into modular files under inc/core/abilities for maintainability and targeted updates.

## [2.1.2] - 2026-03-05

### Fixed
- Fix QR ability for Endroid v6 by using constructor API instead of deprecated QrCode::create().
- Fix QR ability runtime compatibility with Endroid QR Code v6 constructor API.
...
- Align version constant and package.json with 2.0.4 release

## [2.0.4] - 2026-01-22

- Fixed 404 error logger timezone mismatch causing multisite data to be missed in daily emails
- Fixed email recipient to use network admin email instead of site-specific
